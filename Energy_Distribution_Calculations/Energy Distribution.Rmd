...
hydro_raster <- rasterize(shp,r,`field='kWh_year_1')
hydro_raster
plot(hydro_raster)

# This does not display the kWh_year_1 column.
#################################

hydro_raster_2 <- rasterize(shp_2,r,`field='kWh_year_1')
hydro_raster_2
plot(hydro_raster_2)

# This does not work: Error: Incomplete expression: hydro_raster_2 <- rasterize(shp_2,r,`field='kWh_year_1')
