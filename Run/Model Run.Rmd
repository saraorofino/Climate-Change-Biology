...
Step 3: Distribute the Energy
```{r energy_dist}
#within your loop - use for(i in 1:1000)
#thresh.solar <- csv[i,1]
#thresh.wind <- csv[1,2]

# Replicate the code chunk four times - one for each energy source. BUT ALL GOES IN ONE LOOP
#write raster at the end!
```
